                ...
                <div className="">
                    ...
                    <div className="row g-5 align-items-center">
                        ...
                        <div className="col-lg-5">
                            <h1 className="mb-4 h1About text-center"> Patas Sucias
                            </h1>
                            <p className="pAbout">
                                El local fue <b> inaugurado</b> en el verano de 2015, ofrece una gran gama de productos y accesorios para nuestros amiguitos.
                            </p>
                            <p className="mb-4 pAbout"><b> Patas Sucias </b> nació como un emprendimiento familiar, para ofrecer productos de calidad y
                            ...
                            <p className="mb-4 pAbout"><b>Esperamos tus comentarios</b>, eso nos ayuda a seguir mejorando,
